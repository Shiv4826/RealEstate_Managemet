  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-12 col-sm-12 recent-view">
        <h3>About Us</h3>
        <p>We understand that buying or selling a property is one of the most significant decisions you'll ever make, and we are here to guide you every step of the way. Whether you're a first-time homebuyer, an experienced investor, or looking to sell your beloved property, we're here to turn your real estate aspirations into successful transactions.<br><a href="about.html">Learn More</a></p>
         <p>We understand that buying or selling a property is one of the most significant decisions you'll ever make, and we are here to guide you every step of the way. Whether you're a first-time homebuyer, an experienced investor, or looking to sell your beloved property, we're here to turn your real estate aspirations into successful transactions.<br><a href="about.html">Learn More</a></p>
          <p>We understand that buying or selling a property is one of the most significant decisions you'll ever make, and we are here to guide you every step of the way. Whether you're a first-time homebuyer, an experienced investor, or looking to sell your beloved property, we're here to turn your real estate aspirations into successful transactions..<br><a href="about.html">Learn More</a></p>
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>Mini-Project!!</b><br>
<span class="glyphicon glyphicon-map-marker"></span>600073 Chennai , Tamil Nadu India<br>
<span class="glyphicon glyphicon-envelope"></span>www.academicmini-project.com<br>
<span class="glyphicon glyphicon-earphone"></span> +919272777334</p>
            </div>
        </div>
<p class="copyright"> mini@project &#169; Copyright 2021. All rights reserved.	</p>
